...
|----------------------|:------:|:--------:|-------------------------------------------------------------------------------------------------------------------------------------------|
| `products.digitalwizardId` |  int   |   Yes    | Product identifier from `digitalwizardId` field                                                                                                 |
...
curl -X POST \
     ...
     -d '{"products":[{"digitalwizardId":1949,"qty":1,"price":5.79}]}' \
     https://gateway.digitalwizard.com/esa/api/v1/order
```
...
curl -X GET \
     -H 'X-Api-Key: [api-key]' \
     https://gateway.digitalwizard.com/esa/api/v1/order/PHS84FJAG5U
```
...
| `digitalwizardOrderId`        |  int   | Previous order ID                                    |
...
| `products.digitalwizardId`    |  int   | Product ID                                           |
...
curl -X GET \
     -H 'X-Api-Key: [api-key]' \
     https://gateway.digitalwizard.com/esa/api/v1/order?status=processing
```
